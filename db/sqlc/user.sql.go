...
INSERT INTO users (
  ...
  $1, $2, $3, $4
) RETURNING id, full_name, email, hashed_password, password_changed_at, created_at, organization
`
...
SELECT id, full_name, email, hashed_password, password_changed_at, created_at, organization FROM users
WHERE id = $1 LIMIT 1
`
